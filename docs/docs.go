        ...
        "/warps": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by player UUID (with or without hyphens).",
                        "name": "player",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "Limit number of warps returned.",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Number of warps to skip before returning. Can only be used if the limit query parameter is set.",
                        "name": "offset",
                        "in": "query"
                    }
                ],
